...
async def handle_mew():
    await mew.send(MessageSegment.image("https://gchat.qpic.cn/gchatpic_new/0/0-0-911255CF765722233E60FF1FAFDD593C/0"))
...
async def handle_video(event: Event, bot: Bot):
    ...
    await video.send(MessageSegment.video("https://api.yujn.cn/api/xjj.php?type=video"))
    await video.send(MessageSegment.video("https://ml.v.api.aa1.cn/girl-11-02/"))
